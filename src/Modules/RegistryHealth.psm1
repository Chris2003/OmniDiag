...
.DESCRIPTION
    Checks the integrity of a small set of security-relevant registry keys and
    values (Winlogon Shell/Userinit, Run keys) that are common persistence
    targets. All reads fail soft; the module never throws.
